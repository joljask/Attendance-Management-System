...
@WebServlet(name = "ChangePasswordStudent", urlPatterns = {"/ChangePasswordStudent"})
public class ChangePasswordStudent extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(email + "from student login");
        ...
        String sql_query = "UPDATE student SET password = ?  WHERE email = ?";
        ...
        {
            RequestDispatcher display = request.getRequestDispatcher("/changePasswordStudent.jsp");
